...
namespace cvedix_nodes {
    ...
    public:
        ...
        // not all targets in frame should be handled by cvedix_secondary_infer_node.
        std::vector<int> p_class_ids_applied_to;
        int crop_padding;
        // min height of target to be handled by cvedix_secondary_infer_node, 0 means no restriction
        int min_height_applied_to = 0;
        // min width of target to be handled by cvedix_secondary_infer_node，0 means no restriction
        int min_width_applied_to = 0;
    };
