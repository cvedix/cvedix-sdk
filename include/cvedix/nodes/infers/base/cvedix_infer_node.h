...
namespace cvedix_nodes {
    ...
    // we can implement it using other backends such as tensorrt with cuda acceleration, see cvedix_ppocr_text_detector_node which is based on PaddlePaddle dl framework from BaiDu corporation.
