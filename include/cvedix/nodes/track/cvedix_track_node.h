...
namespace cvedix_nodes {
    ...
    enum class cvedix_track_for {
        NORMAL = 1,    // cvedix_frame_target
        FACE = 2       // cvedix_frame_face_target
                       // others to extend
    };
    ...
    private:
        ...
        // std::map<int, std::vector<cvedix_objects::cvedix_rect>> tracks_by_id;
    ...
    protected:
        ...
        // we can also cache history rects for each target, and then push them back to tracks field (like cvedix_frame_target::tracks)
